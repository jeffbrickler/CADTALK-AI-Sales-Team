...
- **Standalone:** The user runs `/ct-contacts <url>`. Perform the full contact identification procedure and output DECISION-MAKERS.md.
...
*Generated by AI Sales Team — `/ct-contacts`*
```
