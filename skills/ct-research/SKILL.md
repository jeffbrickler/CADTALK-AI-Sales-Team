...
- **Standalone:** The user runs `/ct-research <url>`. Perform the full research procedure and output COMPANY-RESEARCH.md.
...
*Generated by AI Sales Team — `/ct-research`*
```
...
- Suggest follow-up: `/ct-contacts` for decision maker deep dive, `/ct-qualify` for opportunity assessment
